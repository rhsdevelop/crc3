...
urlpatterns = [
    ...
    path('comissao-servico/list/', views.list_comissao_servico, name='list_comissao_servico'),
    path('comissao-servico/<int:comissao_servico_id>/edit/', views.edit_comissao_servico, name='edit_comissao_servico'),
    ...
    path('pioneiros/<int:pioneiros_id>/peticao/', views.peticao_pioneiro_auxiliar, name='peticao_pioneiro_auxiliar'),
